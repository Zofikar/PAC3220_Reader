...
REGISTER_MAP = {
    ...
    57: (
        "Average voltage UL-N",
        ModbusTcpClient.DATATYPE.FLOAT32
    ),
    59: (
        "Average voltage UL-L",
        ModbusTcpClient.DATATYPE.FLOAT32
    ),
    61: (
        "Average current",
    ...
    105: (
        "Maximum reactive power L1 (VARn)",
        ModbusTcpClient.DATATYPE.FLOAT32
    ),
    107: (
        "Maximum reactive power L1 (VARn)",
    ...
    131: (
        "Maximum average voltage UL-N",
        ModbusTcpClient.DATATYPE.FLOAT32
    ),
    133: (
        "Maximum average voltage UL-L",
        ModbusTcpClient.DATATYPE.FLOAT32
    ),
    135: (
    ...
    175: (
        "Minimum reactive power L1 (VARn)",
        ModbusTcpClient.DATATYPE.FLOAT32
    ),
    177: (
        "Minimum reactive power L1 (VARn)",
    ...
    189: (
        "Minimum average voltage UL",
        ModbusTcpClient.DATATYPE.FLOAT32
    ),
    191: (
        "Minimum average voltage UL-L",
        ModbusTcpClient.DATATYPE.FLOAT32
    ),
    193: (
    ...
    501: (
        "Cumulated average active power import",
        ModbusTcpClient.DATATYPE.FLOAT32
    ),
    503: (
        "Cumulated average reactive power import",
        ModbusTcpClient.DATATYPE.FLOAT32
    ),
    505: (
        "Cumulated average active power export",
        ModbusTcpClient.DATATYPE.FLOAT32
    ),
    507: (
        "Cumulated average reactive power export",
        ModbusTcpClient.DATATYPE.FLOAT32
    ),
    509: (
        "Maximum active power reading during demand period",
        ModbusTcpClient.DATATYPE.FLOAT32
    ),
    511: (
        "Minimum active power reading during demand period",
        ModbusTcpClient.DATATYPE.FLOAT32
    ),
    513: (
        "Maximum reactive power reading during demand period",
        ModbusTcpClient.DATATYPE.FLOAT32
    ),
    515: (
        "Minimum reactive power reading during demand period",
        ModbusTcpClient.DATATYPE.FLOAT32
    ),
    517: (
        "Length of the current demand period",
        ModbusTcpClient.DATATYPE.UINT32
    ),
    519: (
        "Time since start of current demand period",
        ModbusTcpClient.DATATYPE.UINT32
    ),
    799: (
        "Date/time",
